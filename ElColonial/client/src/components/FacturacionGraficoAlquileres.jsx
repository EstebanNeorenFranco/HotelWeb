...
const FacturacionGraficoAlquileres = () => {
  ...
  const fetchFacturacion = async (selectedYear) => {
    ...
    setError(null);
    try {
      const response = await axios.get(`http://localhost:5000/facturacion/${selectedYear}`);
  ...
  return (
    <div className="flex flex-col items-center p-4 bg-gray-100 min-h-screen">
      <div className="w-full  bg-white shadow-lg rounded-lg p-8 max-w-4xl">
        <h2 className="text-2xl font-semibold mb-6 text-center text-blue-600">Facturación Mensual Alquileres</h2>
...
export default FacturacionGraficoAlquileres;
